  ...
  requestCameraPermission() {
    wx.authorize({
      ...
      success: () => {
        ...
        util.showToast('相机权限已开启', 'success');
      },
      fail: () => {
        wx.showModal({
          title: '权限提醒',
    ...
    wx.chooseImage({
      ...
      success: (res) => {
        ...
        if (fileSize > 10 * 1024 * 1024) { // 10MB
          util.showToast('图片过大，请选择小于10MB的图片');
          return;
        }
  ...
  processImage(imagePath) {
    ...
    setTimeout(() => {
      ...
      app.addIdentifyHistory({
        id: mockResult.variety_id,
        name: mockResult.variety_name,
      ...
      // 跳转到结果页面
      wx.navigateTo({
        url: `/pages/fruit-result/fruit-result?fruitId=${mockResult.fruit_id}&varietyId=${mockResult.variety_id}`
      });
    }, 2000);
  },
